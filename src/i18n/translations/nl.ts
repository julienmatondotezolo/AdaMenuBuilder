...
export const nl: TranslationKeys = {
  ...
  qrMenu: {
    ...
    menuUnavailable: "Dit menu is mogelijk verwijderd of niet beschikbaar.",
    noWebLayout: "Dit menu heeft geen weblay-out geconfigureerd.",
    failedToLoad: "Menu laden mislukt.",
    ...
    orderReadySoon: "Uw bestelling is binnenkort klaar.",
    deliveryMessage: "We bezorgen het bij u.",
    takeawayMessage: "U kunt het binnenkort ophalen.",
    dineInMessage: "Uw bestelling wordt nu bereid.",
