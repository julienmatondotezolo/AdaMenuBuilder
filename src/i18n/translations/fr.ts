...
export const fr: TranslationKeys = {
  ...
  qrMenu: {
    ...
    menuUnavailable: "Ce menu a peut-être été supprimé ou n'est pas disponible.",
    noWebLayout: "Ce menu n'a pas de mise en page web configurée.",
    failedToLoad: "Échec du chargement du menu.",
    ...
    orderReadySoon: "Votre commande sera prête sous peu.",
    deliveryMessage: "Nous vous la livrerons.",
    takeawayMessage: "Vous pourrez la récupérer bientôt.",
    dineInMessage: "Préparation de votre commande en cours.",
